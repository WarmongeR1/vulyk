...
from vulyk.utils import resolve_task_type, HTTPStatus
...
def index():
    ...
    return flask.render_template('index.html', task_types=task_types)
...
def task_home(type_name):
    ...
    return flask.render_template('task.html', task_type=task_type)
